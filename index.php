...
<?php 
    ...
    if($_SERVER['REQUEST_METHOD'] == "POST"){
        ...
        //priprema za izvrsenje sql query-ja
        // on radi i bezbjednost tog query-ja
        // ako neko pokusa neki sql ejection ili tako nesto
        $run = $conn->prepare($sql); 
        $run->bind_param("s", $username); // s znaci da je string
        /// mysqli i pdo nacin (mi radimo mysql uglavnom)
        $run->execute();
